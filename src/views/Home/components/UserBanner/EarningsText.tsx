...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and BBC pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and BBC pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from BBC pool', data)
  }
