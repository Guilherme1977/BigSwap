const config = [
  {
    ...
    description: [
      ...
      'You can instantly swap your WBNB for BNB with no trading fees on BigBoySwap.',
    ],
  },
  {
    title: 'When can I trade other NFT Collections?',
    description: [
      'Soon! The current NFT Market is a basic version (phase 1), with early access to trading BigBoySwap NFTs only.',
  ...
  },
  {
    ...
    description: [
      'Right now, you can only buy and sell NFTs BigBoySwap’s home-made NFT collections on the market.',
  ...
  },
  {
    ...
    description: [
      '100% of all platform fees taken by BigBoySwap from sales are used to buy back and BURN CAKE tokens in our weekly CAKE burns.',
