  ...
  return [
    {
      ...
      bodyText: [t('You’ll need an active BigBoySwap Profile to buy Minting Tickets and mint a Pancake Squad NFT!')],
      buttons: (
        <>
    ...
    },
    {
      ...
      title: t('Hold BBC'),
      bodyText: [t('Each NFT costs BBC to mint. Remember you also need BNB to cover transaction fees too!')],
      buttons: (
        <>
          <Button
            as="a"
